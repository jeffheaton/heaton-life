...
|---|---|---|
| `mandelbrot/`, `julia/`, `burning-ship/`, `newton/` | `iterations.i32` (raw little-endian int32 escape counts, row-major); `roots.i32` for Newton; `orbit.c128` (raw complex128 reference orbit) for deep-zoom cases; `status.i32` (how each count was decided, 0–3) for status cases; `critical.c128` (the critical orbit rebased pixels restart on) for deep Julia cases | [fractals.md](../spec/fractals.md), [deep-zoom.md](../spec/deep-zoom.md) |
