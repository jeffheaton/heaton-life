...
namespace HeatonLife
{
    ...
    public sealed class Julia
    {
        ...
        public Julia(
            double cRe = -0.7269, double cIm = 0.1889, int maxIter = 500, double escapeRadius = 1000.0)
        {
            if (maxIter < 1)
        ...
        /// for the viewport center (Julia orbit: same c, z0 = center). Zoom &lt;= 1e290.
        /// </summary>
                ...
                for (int x = 0; x < width; x++)
                {
                    ...
                    if (t1)
                        count = Perturbation.PerturbZ2(
                            orbitRe!, orbitIm!, ox, oy, 0.0, 0.0, MaxIter, EscapeRadius, out fr, out fi);
                    else
