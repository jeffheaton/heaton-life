...
namespace HeatonLife
{
    ...
    public sealed class Mandelbrot
    {
        ...
        /// for the viewport center — Z_0..Z_n as parallel re/im arrays. Zoom &lt;= 1e290.
        /// </summary>
            ...
            RenderProgress? progress = null)
        {
            ...
            if (t1 && orbitRe == null)
            {
                ...
                (orbitRe, orbitIm) = ReferenceOrbit.Mandelbrot(viewport.CenterRe, viewport.CenterIm, viewport.ZoomLog10, MaxIter);
            }
